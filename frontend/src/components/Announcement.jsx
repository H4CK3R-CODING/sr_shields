  ...
  >
    ...
    {!user ? (
      <div
        ...
        data-aos-delay="200"
      >
        <div className="p-10 rounded-2xl bg-gradient-to-r from-red-500 to-pink-500 text-white shadow-xl">
          <h3 className="text-2xl font-bold mb-3">🔒 Access Restricted</h3>
          <p className="text-lg">You must be logged in to view announcements.</p>
          <Link
            to="/signin"
            className="mt-5 inline-block px-6 py-2 rounded-xl bg-white text-red-600 font-semibold shadow-md hover:shadow-lg hover:scale-[1.05] transition-all duration-300"
          >
            Login Now
          </Link>
        </div>
